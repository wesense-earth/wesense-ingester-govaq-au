...
# Build: docker build -t wesense-ingester-govaq-au .
#
...
COPY wesense-ingester-govaq-au/requirements-docker.txt .
...
COPY wesense-ingester-govaq-au/govaq_ingester.py .
COPY wesense-ingester-govaq-au/adapters/ ./adapters/
COPY wesense-ingester-govaq-au/config/ ./config/

COPY wesense-ingester-govaq-au/entrypoint.sh /app/entrypoint.sh
